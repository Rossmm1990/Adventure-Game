...
class Enemy:
	...
	def __init__(self, name, strength, dexterity, constition, intellegence, wisdom, charisma, armor, health):
		self.name = name
...
Master_player_names_list = ["Olaf", "Udyr", "Ragnar", "Utred", "Appa", "Eric", "Sigmond", "Thorin", "Holfsed", "Beorn"]
...
player2 = Player(random.choice(tuple(Master_player_names_list)))
player3 = Player(random.choice(tuple(Master_player_names_list)))
player4 = Player(random.choice(tuple(Master_player_names_list)))
player5 = Player(random.choice(tuple(Master_player_names_list)))
